  ...
  return (
    ...
    <AlertDialog.Portal>
      ...
      <AlertDialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-slate-800 p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
        ...
        Caso continue, você terá que efetuar o login novamente para acessar a sua conta
        ...
        <div className="flex justify-end gap-[25px]">
          ...
          <AlertDialog.Action asChild>
            <button onClick={handleSairConta} className="text-red-950 bg-red-400 hover:bg-red5 focus:shadow-red7 inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-medium leading-none outline-none focus:shadow-[0_0_0_2px]">
