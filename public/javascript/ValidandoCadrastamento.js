...
const span = document.querySelector('.span__erro');
console.log(span);

const inputNome = document.querySelector('[data-tipo=\'nome\']');
const lableNome = document.querySelector('.lable__nome');

const inputLocalizacao = document.querySelector('[data-tipo=\'localizacao\']');
const lableLocalizacao = document.querySelector('.lable__localizacao');

const inputEmail = document.querySelector('[data-tipo=\'email\']');
const lableEmail = document.querySelector('.lable__email');

const inputSenha = document.querySelector('[data-tipo=\'senha\']');
const lableSenha = document.querySelector('.lable__senha');
