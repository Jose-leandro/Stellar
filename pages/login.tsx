...
import { setEstaValidadoCampos, setQualEstadoUsuario, setQualNomeUsuario } from '../app/lib/redux/actions'
...
function Login (
  { qualNomeUsuario, setQualNomeUsuario, qualEstadoUsuario, setQualEstadoUsuario, setEstaValidadoCampos }:
  { qualNomeUsuario: string, setQualNomeUsuario: (value: string) => void, qualEstadoUsuario: string, setQualEstadoUsuario: (value: string) => void, setEstaValidadoCampos: (value: string) => void }): React.JSX.Element {
  ...
  const handelValidacaoCampos = async (): Promise<void> => {
    ...
    const resultVerificaao = await verificarDadosUsuarios(argumentoVerificacaoDdaosUsuarios)
    ...
    if (!resultVerificaao.senha) {
      ...
      if (inputSenhaRef.current !== null && inputSenhaRef.current !== undefined) {
  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center my-4'>
        ...
        <form className='mt-4 bg-gray-900 border flex flex-col items-center border-gray-900 p-12 rounded sm:w-[70%] md:w-[60%] lg:w-[50%] xl:w-[40%]' id='formLogin' ref={refForm}>
