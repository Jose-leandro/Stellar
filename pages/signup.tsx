...
import { setQualEstadoUsuario, setEstaValidadoCampos, setQualNomeUsuario } from '../app/lib/redux/actions'
...
function Singup({ qualEstadoUsuario, setQualNomeUsuario, estaValidadoCampos, setQualEstadoUsuario, setEstaValidadoCampos, qualNomeUsuario }): React.JSX.Element {
    ...
    <>
      <Header {...headerProps} />
        <div className='flex flex-col items-center my-4'>
          ...
          <form className='mt-4 bg-gray-900 border flex flex-col items-center border-gray-900 p-12 rounded sm:w-[70%] md:w-[60%] lg:w-[50%] xl:w-[40%]' id='formSingup' ref={refForm}>
